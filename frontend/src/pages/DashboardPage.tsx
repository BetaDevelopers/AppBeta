...
import {
    ...
    FolderOpen, Settings, Plus, Wand2, ChevronRight, X, Globe, ShieldCheck, Database, Save, LogOut
} from 'lucide-react'
...
export const DashboardPage: React.FC = () => {
    ...
    const handleOptimize = async () => {
        ...
        if (optimized) {
            updateNote(activeNote.id, { content: optimized })
        }
    }
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <div style={{ position: 'relative' }}>
                        <button
                            ...
                            style={{
                                ...
                                color: isProfileOpen ? accentColor : 'rgba(255,255,255,0.5)',
                            }}
                            title="Mi Perfil"
                        >
                            <User size={20} />
                            ...
                            {isProfileOpen && (
                                <motion.div
                                    ...
                                    style={{
                                        ...
                                        width: '240px', borderRadius: '16px', padding: '8px',
                                ...
                                >
                                    <div style={{ padding: '12px', borderBottom: '1px solid rgba(255,255,255,0.06)', marginBottom: '4px' }}>
                                        <div style={{ fontWeight: '800', fontSize: '14px' }}>{user?.email.split('@')[0] || 'Usuario'}</div>
                                        <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.4)' }}>Estudiante Premium</div>
                                    </div>
                                    <ProfileMenuItem
                                        icon={<User size={14} />}
                                        label="Mi Perfil"
                    ...
                    <button
                        ...
                        style={{
                            ...
                            color: isSidebarOpen ? accentColor : 'rgba(255,255,255,0.5)',
                        }}
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '8px' }}>
                                        ...
                                        >
                                            ...
                                            <span>{isOptimizing ? 'Optimizando...' : 'Optimizar'}</span>
                                        </button>
                                    </div>
                                </div>
                                <input
                        ...
                        <>
                            ...
                            <motion.aside
                                ...
                                style={{
                                    ...
                                    width: '380px', zIndex: 200, display: 'flex', flexDirection: 'column',
                                    boxShadow: '-20px 0 60px rgba(0,0,0,0.4)', background: 'rgba(15, 23, 42, 0.8)',
                                    backdropFilter: 'blur(20px)'
                                }}
                            >
                                ...
                                <div style={{ flex: 1, overflowY: 'auto', padding: '0 8px' }}>
                                    {sidebarTab === 'notes' ? <FilesystemPanel /> : <InsightsPanel />}
                                </div>
...
const headerIconStyle: React.CSSProperties = {
    background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.5)', padding: '8px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s'
}
